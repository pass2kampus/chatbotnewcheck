          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3">
              <div className="border-l-4 border-blue-500 bg-blue-50 pl-3 py-2">
                ...
                <div className="text-sm text-gray-600">€17,500–21,500/year</div>
              </div>
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>• English proficiency (IELTS/TOEFL)</p>
              <p>• Program-specific prerequisites</p>
              <p>• CV, interview, application file</p>
            </div>
          </CardContent>
        </Card>
