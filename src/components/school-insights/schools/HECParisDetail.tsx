        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8 mb-8">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600">Top Business School</p>
              <div className="flex items-center mt-2 text-gray-500">
                <MapPin className="h-4 w-4 mr-2" />
                <span>Jouy-en-Josas, France</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3">
              <div className="bg-yellow-50 border border-yellow-100 p-3 rounded-lg">
                <div className="font-semibold text-yellow-800">#1 Business School Europe</div>
                <div className="text-sm text-yellow-700">Financial Times ranking</div>
              </div>
            </div>
          </CardContent>
        </Card>
