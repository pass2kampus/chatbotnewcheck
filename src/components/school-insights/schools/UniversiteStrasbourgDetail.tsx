        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8 mb-8">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600">Comprehensive University</p>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3">
              <div className="bg-blue-50 border border-blue-100 p-3 rounded-lg">
                ...
                <div className="text-sm text-blue-700">Arts, Sciences, Medicine, Law</div>
              </div>
              <div className="bg-green-50 border border-green-100 p-3 rounded-lg">
                <div className="font-semibold text-green-900">Master's & PhD</div>
                <div className="text-sm text-green-700">Research and professional programs</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-3">
              <div className="bg-yellow-50 border border-yellow-100 p-3 rounded-lg">
                ...
                <div className="text-sm text-yellow-700">IDEX award winner</div>
              </div>
            </div>
          </CardContent>
        </Card>
